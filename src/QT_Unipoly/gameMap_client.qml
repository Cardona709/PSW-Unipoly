...
Item{
    Connections{
        ...
        function onNextPlayerDisable(){
            ...
            if(playerName.text===game_client.getPlayerName(1)){
                playerCheck.background.color=playerCheck.enabled ? "#BF9000" : "#D9D9D9"
                playerCheck.background.border.color= playerCheck.enabled ? "#876500" : "#A6A6A6"
                playerManage.background.color= playerManage.enabled ? "#BF9000" : "#D9D9D9"
                playerManage.background.border.color=playerManage.enabled ? "#876500" : "#A6A6A6"
            }
            else if(playerName.text===game_client.getPlayerName(2)){
                playerCheck.background.color=playerCheck.enabled ? "#385723" : "#D9D9D9"
                playerCheck.background.border.color=playerCheck.enabled ? "#17240e" : "#A6A6A6"
                playerManage.background.color=playerManage.enabled ? "#385723" : "#D9D9D9"
                playerManage.background.border.color=playerManage.enabled ? "#17240e" : "#A6A6A6"
            }
            else if(playerName.text===game_client.getPlayerName(3)){
                playerCheck.background.color=playerCheck.enabled ? "#C00000" : "#D9D9D9"
                playerCheck.background.border.color=playerCheck.enabled ? "#820000" : "#A6A6A6"
                playerManage.background.color=playerManage.enabled ? "#C00000" : "#D9D9D9"
                playerManage.background.border.color=playerManage.enabled ? "#820000" : "#A6A6A6"
            }
        }
        function onMyTurn(){
        ...
        function onWantToBuy(){
            purchaseOptions.visible = true
            popupBackground.visible = true
            propertyName.text = game_client.getProperty()
            propertyPrice.text = game_client.getprice()
        }
        function onClose(){
            myStack.clear()
        ...
        function onUpdatePlayerName(){
            playerName.text = game_client.getMyName_qstring()


            if(game_client.get_number_of_players() === 2){
                playerName.color="#BF9000"
                playerBanner.border.color="#BF9000"
                playerBanner.color="#FFF2CC"
                playerCredits.color="#BF9000"
                playerCheck.background.color=playerCheck.enabled ? "#BF9000" : "#D9D9D9"
                playerCheck.background.border.color= playerCheck.enabled ? "#876500" : "#A6A6A6"
                playerManage.background.color= playerManage.enabled ? "#BF9000" : "#D9D9D9"
                playerManage.background.border.color=playerManage.enabled ? "#876500" : "#A6A6A6"
                playerAvatar.source="assets/images/bengala.png"

                opponent1Name.text = game_client.getPlayerName(0)
                opponent1Banner.color="#B4C7E7"
                opponent1Banner.border.color="#1F4E79"
                opponent1Name.color="#1F4E79"
                opponent1Credits.color="#1F4E79"
                opponent1Avatar.source="assets/images/top_hat.png"

            }
            if(game_client.get_number_of_players() === 3){
                if(game_client.getMyName_qstring()===game_client.getPlayerName(1))
                {
                    playerName.color="#BF9000"
                    playerBanner.border.color="#BF9000"
                    playerBanner.color="#FFF2CC"
                    ...
                    opponent2Name.text = game_client.getPlayerName(2)
                }
                else if(game_client.getMyName_qstring()===game_client.getPlayerName(2)){
                    playerName.color="#385723"
                    playerBanner.border.color="#385723"
                    playerBanner.color="#E2F0D9"
                    playerCredits.color="#385723"
                    playerCheck.background.color=playerCheck.enabled ? "#385723" : "#D9D9D9"
                    playerCheck.background.border.color=playerCheck.enabled ? "#17240e" : "#A6A6A6"
                    playerManage.background.color=playerManage.enabled ? "#385723" : "#D9D9D9"
                    playerManage.background.border.color=playerManage.enabled ? "#17240e" : "#A6A6A6"
                    playerAvatar.source="assets/images/gandafino.png"

                    opponent2Name.text = game_client.getPlayerName(0)
                    opponent2Banner.color="#B4C7E7"
                    opponent2Banner.border.color="#1F4E79"
                    opponent2Name.color="#1F4E79"
                    opponent2Credits.color="#1F4E79"
                    opponent2Avatar.source="assets/images/top_hat.png"

                    opponent1Name.text = game_client.getPlayerName(1)
                }
            }
            else if(game_client.get_number_of_players() === 4){
                if(game_client.getMyName_qstring()===game_client.getPlayerName(1))
                {
                    playerName.color="#BF9000"
                    playerBanner.border.color="#BF9000"
                    ...
                    opponent2Name.text = game_client.getPlayerName(2)
                    opponent3Name.text = game_client.getPlayerName(3)
                }
                else if(game_client.getMyName_qstring()===game_client.getPlayerName(2)){
                    playerName.color="#385723"
                    playerBanner.border.color="#385723"
                ...
                else if(game_client.getMyName_qstring()===game_client.getPlayerName(3)){
                    playerName.color="#C00000"
                    playerBanner.border.color="#C00000"
                    playerBanner.color="#F8CBAD"
                    playerCredits.color="#C00000"
                    playerCheck.background.color=playerCheck.enabled ? "#C00000" : "#D9D9D9"
                    playerCheck.background.border.color=playerCheck.enabled ? "#820000" : "#A6A6A6"
                    playerManage.background.color=playerManage.enabled ? "#C00000" : "#D9D9D9"
                    playerManage.background.border.color=playerManage.enabled ? "#820000" : "#A6A6A6"
                    playerAvatar.source="assets/images/colher.png"

                    opponent3Name.text = game_client.getPlayerName(0)
                    opponent3Banner.color="#B4C7E7"
                    opponent3Banner.border.color="#1F4E79"
                    opponent3Name.color="#1F4E79"
                    opponent3Credits.color="#1F4E79"
                    opponent3Avatar.source="assets/images/top_hat.png"
        ...
        function onUpdatePlayerCredits(){
            if(game_client.get_number_of_players() === 2){
                playerCredits.text="ECTS: "+game_client.getPlayerCredit(1)
                opponent1Credits.text="ECTS: "+game_client.getPlayerCredit(0)
            }
            if(game_client.get_number_of_players() === 3){
                if(game_client.getMyName_qstring()===game_client.getPlayerName(1))
                {
                    playerCredits.text="ECTS: "+game_client.getPlayerCredit(1)
                    opponent1Credits.text="ECTS: "+game_client.getPlayerCredit(0)
                    opponent2Credits.text="ECTS: "+game_client.getPlayerCredit(2)
                }
                else if(game_client.getMyName_qstring()===game_client.getPlayerName(2)){
                    playerCredits.text="ECTS: "+game_client.getPlayerCredit(2)
                    opponent1Credits.text="ECTS: "+game_client.getPlayerCredit(1)
                    opponent2Credits.text="ECTS: "+game_client.getPlayerCredit(0)
                }
            }
            else if(game_client.get_number_of_players() === 4){
                if(game_client.getMyName_qstring()===game_client.getPlayerName(1))
                {
                    ...
                    opponent1Credits.text="ECTS: "+game_client.getPlayerCredit(0)
                    opponent2Credits.text="ECTS: "+game_client.getPlayerCredit(2)
                    opponent3Credits.text="ECTS: "+game_client.getPlayerCredit(3)
                }
                else if(game_client.getMyName_qstring()===game_client.getPlayerName(2)){
                    playerCredits.text="ECTS: "+game_client.getPlayerCredit(2)
                    opponent1Credits.text="ECTS: "+game_client.getPlayerCredit(1)
                    ...
                    playerCredits.text="ECTS: "+game_client.getPlayerCredit(3)
                    opponent1Credits.text="ECTS: "+game_client.getPlayerCredit(1)
                    opponent2Credits.text="ECTS: "+game_client.getPlayerCredit(2)
                    opponent3Credits.text="ECTS: "+game_client.getPlayerCredit(3)
                }
        ...
        function onUpdatePlayerPosition(){
            if (game_client.getPlayerPosition(0) >= 0 && game_client.getPlayerPosition(0) < 10)
            {
                playerBall.x = map.bottom_row_positions[game_client.getPlayerPosition(0)]
                playerBall.y = 635
            }

            else if (game_client.getPlayerPosition(0) >= 10 && game_client.getPlayerPosition(0) < 20)
            {
                playerBall.x = 15
                playerBall.y = map.left_column_positions[game_client.getPlayerPosition(0)-10]
            }

            else if (game_client.getPlayerPosition(0) >= 20 && game_client.getPlayerPosition(0) < 30)
            {
                playerBall.x = map.top_row_positions[game_client.getPlayerPosition(0)-20]
                playerBall.y = 15
            }

            else if (game_client.getPlayerPosition(0) >= 30 && game_client.getPlayerPosition(0) < 40)
            {
                playerBall.x = 635
                playerBall.y = map.right_column_positions[game_client.getPlayerPosition(0)-30]
            }

            if (game_client.getPlayerPosition(1) >= 0 && game_client.getPlayerPosition(1) < 10)
            {
                opponent1Ball.x = map.bottom_row_positions[game_client.getPlayerPosition(1)] + playerBall.width + 5
                opponent1Ball.y = 635
            }

            else if (game_client.getPlayerPosition(1) >= 10 && game_client.getPlayerPosition(1) < 20)
            {
                opponent1Ball.x = 15 + playerBall.width + 5
                opponent1Ball.y = map.left_column_positions[game_client.getPlayerPosition(1)-10]
            }

            else if (game_client.getPlayerPosition(1) >= 20 && game_client.getPlayerPosition(1) < 30)
            {
                opponent1Ball.x = map.top_row_positions[game_client.getPlayerPosition(1)-20] + playerBall.width + 5
                opponent1Ball.y = 15
            }

            else if (game_client.getPlayerPosition(1) >= 30 && game_client.getPlayerPosition(1) < 40)
            {
                opponent1Ball.x = 635 + playerBall.width + 5
                opponent1Ball.y = map.right_column_positions[game_client.getPlayerPosition(1)-30]
            }

            if(game_client.get_number_of_players()>2){
                if (game_client.getPlayerPosition(2) >= 0 && game_client.getPlayerPosition(2) < 10)
                {
                    opponent2Ball.x = map.bottom_row_positions[game_client.getPlayerPosition(2)]
                    opponent2Ball.y = 635 + playerBall.height + 5
                }

                else if (game_client.getPlayerPosition(2) >= 10 && game_client.getPlayerPosition(2) < 20)
                {
                    opponent2Ball.x = 15
                    opponent2Ball.y = map.left_column_positions[game_client.getPlayerPosition(2)-10] + playerBall.height + 5
                }

                else if (game_client.getPlayerPosition(2) >= 20 && game_client.getPlayerPosition(2) < 30)
                {
                    opponent2Ball.x = map.top_row_positions[game_client.getPlayerPosition(2)-20]
                    opponent2Ball.y = 15 + playerBall.height + 5
                }

                else if (game_client.getPlayerPosition(2) >= 30 && game_client.getPlayerPosition(2) < 40)
                {
                    opponent2Ball.x = 635
                    opponent2Ball.y = map.right_column_positions[game_client.getPlayerPosition(2)-30] + playerBall.height + 5
                }
            }

            if(game_client.get_number_of_players()>3){
                if (game_client.getPlayerPosition(3) >= 0 && game_client.getPlayerPosition(3) < 10)
                {
                    opponent3Ball.x = map.bottom_row_positions[game_client.getPlayerPosition(3)] + playerBall.width + 5
                    opponent3Ball.y = 635 + playerBall.height + 5
                }

                else if (game_client.getPlayerPosition(3) >= 10 && game_client.getPlayerPosition(3) < 20)
                {
                    opponent3Ball.x = 15 + playerBall.width + 5
                    opponent3Ball.y = map.left_column_positions[game_client.getPlayerPosition(3)-10] + playerBall.height + 5
                }

                else if (game_client.getPlayerPosition(3) >= 20 && game_client.getPlayerPosition(3) < 30)
                {
                    opponent3Ball.x = map.top_row_positions[game_client.getPlayerPosition(3)-20] + playerBall.width + 5
                    opponent3Ball.y = 15 + playerBall.height + 5
                }

                else if (game_client.getPlayerPosition(3) >= 30 && game_client.getPlayerPosition(3) < 40)
                {
                    opponent3Ball.x = 635 + playerBall.width + 5
                    opponent3Ball.y = map.right_column_positions[game_client.getPlayerPosition(3)-30] + playerBall.height + 5
                }
            }
        ...
        function onUpdateProperty(property_name, color, rent, name){
            var i=0
            if(game_client.getMyName_qstring()===name){
            ...
            else if(opponent1Name.text===name){
            ...
            else if(opponent2Name.text===name){
            ...
            else if(opponent3Name.text===name){
        ...
        function onInJail(){
            ...
            if(game_client.get_current_balance()>=50){
    ...
    Rectangle {
        ...
        Rectangle{
            ...
            Image {
                ...
                MouseArea{
                    ...
                    cursorShape: Qt.PointingHandCursor
                    onClicked: {
                        playerForfeit.enabled = !playerForfeit.enabled
                        client.sendDiceRoll()
                ...
                delegate: Rectangle {
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                                ...
                                opponentCheckRentValue.text = game_client.getRent(opponent1CheckName.text)
                                opponentCheckHousesValue.text = game_client.getHouses(opponent1CheckName.text)
                ...
                delegate: Rectangle {
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                                ...
                                opponentCheckColorValue.text = propColor
                                opponentCheckRentValue.text = game_client.getRent(opponent2CheckName.text)
                                opponentCheckHousesValue.text = game_client.getHouses(opponent2CheckName.text)
                        }
                        cursorShape: Qt.PointingHandCursor
                    }
                ...
                delegate: Rectangle {
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                                ...
                                opponentCheckColorValue.text = propColor
                                opponentCheckRentValue.text = game_client.getRent(opponentCheck3Name.text)
                                opponentCheckHousesValue.text = game_client.getHouses(opponentCheck3Name.text)
                        }
                        cursorShape: Qt.PointingHandCursor
                    }
        ...
        Rectangle {
            ...
            // add button to mortgage property
            ...
            // add button to unmortgage property
